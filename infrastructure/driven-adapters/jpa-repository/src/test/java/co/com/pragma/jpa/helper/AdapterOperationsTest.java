...
import co.com.pragma.jpa.adapter.JPARepositoryTicketingAdapter;
...
class AdapterOperationsTest {
    ...
    @Mock
    private JPATicketingRepository repository;

    @Mock
    private ObjectMapper objectMapper;

    private JPARepositoryTicketingAdapter adapter;
    ...
    void setUp() {
        ...
        adapter = new JPARepositoryTicketingAdapter(repository, objectMapper);
    }
